...
# Locate the binrun runner and exec the cc-review descriptor.
#
# This renders to plugin scripts/install-binary.sh — the successor to the
# provision-a-symlink installer. bin/cc-review is a committed symlink to it, so
...
# resolves and execs the version-exact artifact the sidecar bin/cc-review.binrun
...
ROOT="$(cd "$d/.." && pwd)"
DESCRIPTOR="$ROOT/bin/cc-review.binrun"
